...
import { List, Switch, NavBar, Icon } from 'antd-mobile';
...
class EntList extends React.Component {
    ...
    componentDidMount() {
        // requestApi('get','/get_wrapkey?fileid=123456&userid=123456',null,function (res) {
        //     console.log(res)
        // });
        // requestApi('post','/delete_wrapkey',{
        //     fileid:123456,
        //     userid:123456
        // },function(res){
        //     console.log(res)
...
export default createForm()(EntList);